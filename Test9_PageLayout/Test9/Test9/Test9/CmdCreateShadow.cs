...
namespace Test9
{
    ...
    /// </summary>
    [Guid("431dddfc-b017-4a01-8b9a-e9c0317abb79")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("Test9.CmdCreateShadow")]
    public sealed class CmdCreateShadow : BaseCommand
    {
        ...
        public override void OnClick()
        {
            ...
            IFrameProperties pFrameProperties = (IFrameProperties)graphicsContainer.FindFrame(m_hookHelper.FocusMap);
