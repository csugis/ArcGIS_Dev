...
namespace Test9
{
    public sealed partial class MainForm : Form
    {
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                //设置axToolbarControl1控件关联axMapControl1控件
        ...
        private void 设置边框ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            ICommand command = new CmdCreatShadow();
            command.OnCreate(m_PageLayoutControl.Object);
            command.OnClick();
        ...
        {
            ICommand command = new CmdCreatBackG();
            command.OnCreate(m_PageLayoutControl.Object);
            command.OnClick();
