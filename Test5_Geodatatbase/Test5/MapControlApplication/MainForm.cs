...
namespace MapControlApplication
{
    public sealed partial class MainForm : Form
    {
        ...
        private void newFeatureClassToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void newFeatureToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ICommand command = new ToolCreateFeature();
            command.OnCreate(m_mapControl.Object);
